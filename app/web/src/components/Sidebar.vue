    ...
    >
      ...
      <nav class="mt-10">
        ...
        >
          ...
          <span class="mx-4">{{ 'Network Configuration' }}</span>
        </router-link>
        <router-link
          class="flex items-center duration-200 mt-4 py-2 px-6 border-l-4"
        ...
        >
          ...
          <span class="mx-4">{{ 'Network Setup' }}</span>
        </router-link>
        <router-link
          class="flex items-center duration-200 mt-4 py-2 px-6 border-l-4"
        ...
        <router-link
          class="flex items-center duration-200 mt-4 py-2 px-6 border-l-4"
          :class="[$route.name === 'Explorer' ? activeClass : inactiveClass]"
          to="/explorer"
        >
          <svg
            class="h-5 w-5"
